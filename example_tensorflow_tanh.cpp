...
// Input: x
// Output: sin(x) (or tanh(x) )
// Model: Dense feed-forward NN
// By MGM, 05/11/2022 
...
int main(int argc, char** argv)
{
  ...
  TF_Output t0 = {TF_GraphOperationByName(Graph, "serving_default_dense_input"), 0};
  if(t0.oper == NULL)
    printf("ERROR: Failed TF_GraphOperationByName serving_default_dense_input\n");
  else
    printf("TF_GraphOperationByName serving_default_dense_input is OK\n");
  ...
  int ndims = 2;
  int64_t dims[] = {1,1};
  float   data[] = {0.5*3.141592};
  int ndata = sizeof(float)*1; // number of bytes not number of element
